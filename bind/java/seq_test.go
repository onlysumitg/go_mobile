...
import (
	...
	"github.com/onlysumitg/go_mobile/internal/importers/java"
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/onlysumitg/go_mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/onlysumitg/go_mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
