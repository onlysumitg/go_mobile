...
//
//	$ go get -d github.com/onlysumitg/go_mobile/example/network
//	$ gomobile build github.com/onlysumitg/go_mobile/example/network # will build an APK
//
//	# plug your Android device to your computer or start an Android emulator.
//	# if you have adb installed on your machine, use gomobile install to
//	# build and deploy the APK to an Android target.
//	$ gomobile install github.com/onlysumitg/go_mobile/example/network
//
...
//
//	$ go install github.com/onlysumitg/go_mobile/example/network && network
package main
