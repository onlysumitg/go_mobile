...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/onlysumitg/go_mobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/onlysumitg/go_mobile", "github.com/onlysumitg/go_mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/onlysumitg/go_mobile", "github.com/onlysumitg/go_mobile", 2},
		{"ffffffff t github.com/example/github.com/onlysumitg/go_mobile", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/onlysumitg/go_mobile/app", "github.com/onlysumitg/go_mobile/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/onlysumitg/go_mobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
