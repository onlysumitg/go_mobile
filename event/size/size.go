...
//
// See the github.com/onlysumitg/go_mobile/app package for details on the event model.
package size // import "github.com/onlysumitg/go_mobile/event/size"

import (
	"image"

	"github.com/onlysumitg/go_mobile/geom"
)
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/onlysumitg/go_mobile/geom package.
	//
